...
import static dao.StudyGroupStatements.*;
...
public class StudyGroupDao {
    ...
    public List<StudyGroup> findAll() {
        try (var statement = connection.prepareStatement(SELECT_ALL_GROUPS)) {
            ...
            while (resultSet.next()) {
                ...
                studyGroup.setCreationDate(resultSet.getDate("creation_date"));
                ...
                admin.setBirthday(resultSet.getDate("admin_birthday"));
    ...
    public void create(StudyGroup studyGroup) {
        studyGroup.setCreationDate(new java.util.Date());
        try (var statement = connection.prepareStatement(INSERT_INTO_GROUPS, Statement.RETURN_GENERATED_KEYS)) {
            ...
            else statement.setDate(8, new Date(studyGroup.getGroupAdmin().getBirthday().getTime()));
            ...
            statement.setDate(15, new Date(studyGroup.getCreationDate().getTime()));
            statement.executeUpdate();
